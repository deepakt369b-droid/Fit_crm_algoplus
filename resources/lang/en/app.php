...
return [
    ...
    'whatsapp' => [
        ...
        'trigger' => 'Trigger',
        'triggers' => [
            'contact_created' => 'New contact messages in',
            'keyword_received' => 'Keyword received',
            'opted_in' => 'Contact opts in',
        ],
        'trigger_keyword' => 'Keyword',
        'applies_to_number' => 'Applies to number',
        'any_number' => 'Any number',
        'select_number_first' => 'Select a phone number above first.',
        'steps' => 'Steps',
        'add_step' => 'Add step',
        'new_step' => 'New step',
        'step_type' => 'Step type',
        ...
        'true_step' => 'If true, go to step #',
        'false_step' => 'If false, go to step #',
        'step_index_hint' => 'Step number, counting from 0 (the first step).',
    ...
    'settings' => [
        ...
        'fields' => [
            ...
            'ai_model' => 'Model',
            'ai_model_helper' => 'Exact model ID for your chosen provider — check their docs, as this changes often.',
            'ai_base_url' => 'API Base URL (optional)',
            'ai_base_url_helper' => "Override the provider's default endpoint — e.g. a self-hosted or region-specific gateway. Leave blank to use the default.",
